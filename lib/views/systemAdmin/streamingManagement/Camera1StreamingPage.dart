...
class Camera1StreamingPage extends StatefulWidget {
  final WebSocketChannel channel;
  const Camera1StreamingPage({super.key, required this.channel});

  @override
  State<Camera1StreamingPage> createState() => _Camera1StreamingPageState();
}

class _Camera1StreamingPageState extends State<Camera1StreamingPage> {
